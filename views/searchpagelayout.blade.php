...
<body>
     <div id="Menu" class="nano has-scrollbar Menu menu-closed">
...
<div class="search">
    ...
    {{ Form::text('query', $key, array('class'=>'searchbox-input-left' )) }}
...
<div class="search">
    ...
    {{ Form::open(array('url' =>'/Search','class'=>'searchbox searchname-open searchname-open searchbox-open' )) }}

    {{ Form::text('query', $key, array('class'=>'searchbox-input' )) }}
